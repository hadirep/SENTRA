...
const dataArtProvience = [
  ArtProvince(
    ...
    image: "assets/logo_prov/1_aceh.png",
  ),
  ArtProvince(
    province: "Bangka Belitung",
    name: "Tari Campak",
    price: 6000000,
    description: "Tari Campak. Tarian yang merupakan tarian dari daerah Bangka Belitung ini, menggambarkan keceriaan bujang dan dayang di Kepulauan Bangka Belitung."
    ...
    image: "assets/logo_prov/2_bangka_belitung.png",
  ),
  ArtProvince(
    province: "Bali",
    name: "Tari Kecak",
    ...
    image: "assets/logo_prov/3_bali.png",
  ),
  ArtProvince(
    province: "Banten",
    name: "Debus",
    price: 2500000,
    description: "Debus merupakan kesenian tradisional yang terdapat di Provinsi Banten yang menampilkan atraksi kekebalan tubuh manusia dari berbagai macam benda tajam."
  ...
  ArtProvince(
    ...
    image: "assets/logo_prov/5_dki_jakarta.png",
  ),
  ArtProvince(
    province: "Jawa Barat",
    name: "Pertunjukan Angklung",
    price: 50000000,
    description: "Angklung adalah alat musik bernada ganda yang telah dikenal sejak abad ke 11."
    ...
    image: "assets/logo_prov/6_jawa_barat.png",
  ),
  ArtProvince(
    province: "Jawa Timur",
    name: "Wayang Kulit",
    price: 6000000,
    description: "Seni Wayang Kulit telah ditetapkan UNESCO sebagai Warisan Budaya Tak Benda pertama Indonesia dalam kategori Representative List of the Intangible Cultural Heritage of Humanity pada tahun 2003."
    ...
    image: "assets/logo_prov/7_jawa_timur.png",
  ),
  ArtProvince(
    province: "Kalimantan Barat",
    name: "Tari Pedang Mualang",
    price: 8000000,
    description: "Tari Pedang Mualang– Kalimantan Barat menjadi salah satu daerah yang kaya akan budaya tradisionalnya yang masih dipegang teguh dan dirawat hingga sekarang."
    ...
    image: "assets/logo_prov/8_kalimantan_barat.png",
  ),
  ArtProvince(
    province: "Kalimantan Selatan",
    name: "Tari Topeng Banjar",
    price: 7500000,
    description: "Tari Topeng Banjar adalah jenis tarian tradisional yang dipergunakan dalam upacara sakral, seperti upacara manyanggar (Sampir). Tarian untuk upacara sakral ini bisa juga berfungsi untuk keperluan Batatamba (pengobatan) terhadap orang sakit seperti kapingitan."
    ...
    image: "assets/logo_prov/9_kalimantan_selatan.png",
  ),
  ArtProvince(
    province: "Kalimantan Tengah",
    name: "Tari Giring-Giring",
    price: 7000000,
    description: "Tari Giring-Giring adalah tarian khas yang berasal dari Suku Dayak Maanyan yang mendiami Provinsi Kalimantan Tengah."
    ...
    image: "assets/logo_prov/10_kalimantan_tengah.png",
  ),
  ArtProvince(
    province: "Kalimantan Timur",
    name: "Tari Gantar",
    price: 8000000,
    description: "Tari Gantar berasal dari Suku Dayak Benuaq dan Dayak Tunjung di Kabupaten Kutai Barat, Kalimantan Timur."
    ...
    image: "assets/logo_prov/11_kalimantan_timur.png",
  ),
  ArtProvince(
    province: "Kalimantan Utara",
    name: "Tari Mance",
    price: 9000000,
    description: "Tari Mance atau Bemance adalah tarian daerah yang berasal dari Kalimantan Utara, Suku Bulungan."
    ...
    image: "assets/logo_prov/12_kalimantan_utara.png",
  ),
  ArtProvince(
    province: "Lampung",
    name: "Tari Bendana",
    ...
    image: "assets/logo_prov/13_lampung.png",
  ),
  ArtProvince(
    province: "Maluku",
    name: "Tari Yerik",
    price: 11500000,
    description: "Tari Yerik merupakan merupakan tarian masyarakat Maluku sebagai bentuk permintaan kepada Tuhan untuk keselamatan ketika bencana datang seperti badai yang tidak berhenti, perang yang tidak berakhir dan musim kemarau yang panjang agar diberi hujan."
    ...
    image: "assets/logo_prov/14_maluku.png",
  ),
  ArtProvince(
    province: "NTB",
    name: "Tari Gandrung",
    price: 11000000,
    description: "Tarian Gandrung yang merupakan khas Banyuwangi dibawakan sebagai perwujudan rasa syukur masyarakat setelah panen. Gandrung merupakan seni pertunjukan yang disajikan dengan iringan musik khas perpaduan budaya Jawa dan Bali."
  ...
  ArtProvince(
    ...
    image: "assets/logo_prov/16_ntt.png",
  ),
  ArtProvince(
    province: "Papua",
    name: "Tari Musyoh",
    ...
    image: "assets/logo_prov/17_papua.png",
  ),
  ArtProvince(
    province: "Riau",
    name: "Tari Zipin",
    price: 5600000,
    description: "Tari Zapin adalah salah satu tarian tradisional Melayu dari Provinsi Riau yang sangat mengakar dan populer. Zapin berasal dari bahasa Arab yaitu yang mempunyai arti pergerakan kaki cepat mengikut rentak pukulan."
    ...
    image: "assets/logo_prov/18_riau.png",
  ),
  ArtProvince(
    ...
    image: "assets/logo_prov/19_sumatera_barat.png",
  ),
  ArtProvince(
    province: "Sulawesi Selatan",
    name: "Tari Kipas Pakarena",
    price: 6700000,
    description: "Tarian kipas adalah kesenian tari daerah yang berasal dari Gowa, Provinsi Sulawesi Selatan. Di daerah Gowa, nama tarian ini mempunyai nama Tari Kipas Pakarena."
    ...
    image: "assets/logo_prov/20_sulawesi_selatan.png",
  ),
  ArtProvince(
    province: "Sulawesi Utara",
    name: "Tari Maengket",
    price: 8500000,
    description: "Tari Maengket salah satu tari tradisional suku Minahasa di Sulawesi Utara. Tari Maengket awalnya menjadi tarian ucapan terima kasih kepada Tuhan Yang Maha Esa atas panen yang baik."
    ...
    image: "assets/logo_prov/21_sulawesi_utara.png",
  ),
  ArtProvince(
    province: "Sumatera Selatan",
    name: "Tari Gending Sriwijaya",
    price: 12000000,
    description: "Tari Gending Sriwijaya merupakan tarian tradisional dari Palembang, Sumatera Selatan. Tari tradisional ini digunakan untuk menyambut tamu para raja yang tak hanya indah namun penuh dengan makna."
    ...
    image: "assets/logo_prov/22_sumatera_selatan.png",
  ),
  ArtProvince(
    province: "Sumatera Utara",
    name: "Tari Tor Tor",
    price: 9900000,
    description: "Tari Tortor merupakan salah satu jenis tarian yang berasal dari provinsi Sumatera Utara. Tari Tortor adalah jenis tarian purba dari masyarakat Batak Toba yang mendiami provinsi dengan ibukota Medan."
    ...
    image: "assets/logo_prov/23_sumatera_utara.png",
  ),
  ArtProvince(
    province: "Yogyakarta",
    name: "Tari Serimpi",
    price: 9000000,
    description: "Tari serimpi berasal dari tradisi keraton Mataram yang waktu itu masih berada di Daerah Istimewa Yogyakarta. Sehingga, bisa dikatakan bahwa tari serimpi berasal dari Daerah Istimewa Yogyakarta."
    ...
    image: "assets/logo_prov/24_yogyakarta.png",
  ),
];
