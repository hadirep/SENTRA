  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Settings', style: TextStyle(color: Color.fromARGB(255, 45, 74, 148),fontWeight: FontWeight.bold, fontSize: 24), ),
        centerTitle: true,
        leading:
                  ...
                  children: [
                    ...
                    Card(
                      child: ListTile(
                        ...
                        trailing: const Icon(Icons.navigate_next, color: Color(0xffdc7e00)),
                        onTap: () {Navigator.pushNamed(context, ProductManagement.routeName);},
                      ),
                    ),
                    Card(
                      child: ListTile(
                        leading: const Icon(Icons.login_outlined, color: Color(0xffF0BE41)),
                        title: const Text(
                          'Logout',
                          style: TextStyle(
                              color: buttonPrimaryColor,
