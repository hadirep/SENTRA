...
class WidgetArtListMore extends StatefulWidget {
  ...
  const WidgetArtListMore({Key? key, required this.artList}) : super(key: key);

  @override
  State<WidgetArtListMore> createState() => _WidgetArtListMoreState();
}

class _WidgetArtListMoreState extends State<WidgetArtListMore> {
  @override
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image:
                            NetworkImage(baseImageArt + widget.artList.image),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
