...
import 'package:sentra/common/utils.dart';
      ...
      Padding(
        ...
        child: BlocBuilder<FavoriteBloc, FavoriteState>(
          builder: (context, state) {
            if (state is FavoriteArtHasData) {
              return const Center(
                child: CircularProgressIndicator(),
              );
            } else if (state is FavoriteArtHasData) {
              return ListView.builder(
                itemBuilder: (context, index) {
                  final art = state.result[index];
                  return ArtCard(art);
                },
                itemCount: state.result.length,
              );
            } else if (state is FavoriteArtEmpty) {
              return const Center(
                child: Center(child: Text("There's no art that youre add on watchlist", style: TextStyle(color: Colors.white),),),
