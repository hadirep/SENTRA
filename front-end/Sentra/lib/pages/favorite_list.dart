...
//       SafeArea(
//         child: 
//         Padding(padding: const EdgeInsets.only(bottom:15.0, left: 15.0, right: 15.0),
//         child: Container(
//           child: Column(
...
//                   prefixIcon: Container(padding:EdgeInsets.all(10), child: Icon(Icons.search,)),
//                   border: OutlineInputBorder(
//                     borderRadius: BorderRadius.circular(10),
//                     borderSide: const BorderSide(color: Color.fromARGB(255, 240, 190, 65), width: 0.0)
//                   ), 
//                 ),
//               ),
//             ),
